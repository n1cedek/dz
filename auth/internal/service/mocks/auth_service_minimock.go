...
func (mmCreate *mAuthServiceMockCreate) Expect(ctx context.Context, info *modelRepo.User) *mAuthServiceMockCreate {
...
func (mmCreate *mAuthServiceMockCreate) ExpectInfoParam2(info *modelRepo.User) *mAuthServiceMockCreate {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("AuthServiceMock.Create mock is already set by Set")
	}
...
func (mmCreate *mAuthServiceMockCreate) Inspect(f func(ctx context.Context, info *modelRepo.User)) *mAuthServiceMockCreate {
...
func (mmCreate *mAuthServiceMockCreate) Set(f func(ctx context.Context, info *modelRepo.User) (i1 int64, err error)) *AuthServiceMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mAuthServiceMockCreate) When(ctx context.Context, info *modelRepo.User) *AuthServiceMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("AuthServiceMock.Create mock is already set by Set")
	}
...
func (mmCreate *AuthServiceMock) Create(ctx context.Context, info *modelRepo.User) (i1 int64, err error) {
...
func (mmGet *mAuthServiceMockGet) Return(pp1 *model.PublicInfo, err error) *AuthServiceMock {
	if mmGet.mock.funcGet != nil {
		mmGet.mock.t.Fatalf("AuthServiceMock.Get mock is already set by Set")
	}
	...
	mmGet.defaultExpectation.results = &AuthServiceMockGetResults{pp1, err}
	mmGet.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
	return mmGet.mock
}

// Set uses given function f to mock the AuthService.Get method
func (mmGet *mAuthServiceMockGet) Set(f func(ctx context.Context, id int64) (pp1 *model.PublicInfo, err error)) *AuthServiceMock {
	if mmGet.defaultExpectation != nil {
...
func (e *AuthServiceMockGetExpectation) Then(pp1 *model.PublicInfo, err error) *AuthServiceMock {
	e.results = &AuthServiceMockGetResults{pp1, err}
	return e.mock
}
...
func (mmGet *AuthServiceMock) Get(ctx context.Context, id int64) (pp1 *model.PublicInfo, err error) {
